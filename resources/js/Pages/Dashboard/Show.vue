        ...
        <b-row>
            <b-col cols="12">
                <b-jumbotron>
                    <b-container fluid>
                        <b-row>
                            <a class="col-sm-4 col-md-3 p-0 mr-sm-4 mb-4" :href="route('profile.show')">
                            ...
                            <a class="col-sm-4 col-md-3 p-0 mr-sm-4 mb-4" :href="route('my-resources')">
                            ...
                            <a class="col-sm-4 col-md-3 p-0 mr-sm-4 mb-4" :href="route('favourite.index')">
            ...
            <b-col cols="12" v-if="$page.is_admin">
                <b-jumbotron>
                    <b-container fluid>
                        <b-row>
                            <a class="col-sm-4 col-md-3 p-0 mr-sm-4 mb-4" :href="route('users.index')">
                                <b-aspect aspect="square" class="tile  shadow-light" style="background: #0066FF">
                                    <b-icon-people font-scale="2" class="tile-icon text-white">
                                    </b-icon-people>
                                    <span class="tile-content">Пользователи</span>
                                </b-aspect>
                            </a>
                        </b-row>
                    </b-container>
